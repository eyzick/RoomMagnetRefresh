...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="container">
      ...
      <div class="row">
          ...
          <div class="col-md-3"><asp:TextBox ID="tbDOB" runat="server" type="date" placeholder="Date of Birth" CssClass="form-control"></asp:TextBox></div>
      ...
      <div class="row">
          ...
          <div class="col-md-4"><asp:Button ID="btnPopulate" runat="server" Text="Populate" OnClick="btnPopulate_Click" /></div>
      </div>
      <br />
      <div class="row">
